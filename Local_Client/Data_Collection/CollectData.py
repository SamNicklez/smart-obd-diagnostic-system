...
class DataCollector:
    def __init__(self, update_gui_callback=None):
        ...
        self.available_commands = {
            ...
            "AUX_INPUT_STATUS": {"command": "AUX_INPUT_STATUS", "name": "Aux Input Status (Power Take Off)", "unit": ""},
            ...
            "FUEL_RAIL_PRESSURE_VAC": {"command": "FUEL_RAIL_PRESSURE_VAC", "name": "Fuel Rail Pressure (relative to Vacuum)", "unit": "kPa"},
            "FUEL_RAIL_PRESSURE_DIRECT": {"command": "FUEL_RAIL_PRESSURE_DIRECT", "name": "Fuel Rail Pressure (direct inject)", "unit": "kPa"},
            "O2_S1_WR_VOLTAGE": {"command": "O2_S1_WR_VOLTAGE", "name": "02 Sensor 1 WR Lambda Voltage", "unit": "Volts"},
            "O2_S2_WR_VOLTAGE": {"command": "O2_S2_WR_VOLTAGE", "name": "02 Sensor 2 WR Lambda Voltage", "unit": "Volts"},
            "O2_S3_WR_VOLTAGE": {"command": "O2_S3_WR_VOLTAGE", "name": "02 Sensor 3 WR Lambda Voltage", "unit": "Volts"},
            "O2_S4_WR_VOLTAGE": {"command": "O2_S4_WR_VOLTAGE", "name": "02 Sensor 4 WR Lambda Voltage", "unit": "Volts"},
            "O2_S5_WR_VOLTAGE": {"command": "O2_S5_WR_VOLTAGE", "name": "02 Sensor 5 WR Lambda Voltage", "unit": "Volts"},
            "O2_S6_WR_VOLTAGE": {"command": "O2_S6_WR_VOLTAGE", "name": "02 Sensor 6 WR Lambda Voltage", "unit": "Volts"},
            "O2_S7_WR_VOLTAGE": {"command": "O2_S7_WR_VOLTAGE", "name": "02 Sensor 7 WR Lambda Voltage", "unit": "Volts"},
            "O2_S8_WR_VOLTAGE": {"command": "O2_S8_WR_VOLTAGE", "name": "02 Sensor 8 WR Lambda Voltage", "unit": "Volts"},
            ...
            "CATALYST_TEMP_B1S1": {"command": "CATALYST_TEMP_B1S1", "name": "Catalyst Temperature: Bank 1 - Sensor 1", "unit": "°F"},
            "CATALYST_TEMP_B2S1": {"command": "CATALYST_TEMP_B2S1", "name": "Catalyst Temperature: Bank 2 - Sensor 1", "unit": "°F"},
            "CATALYST_TEMP_B1S2": {"command": "CATALYST_TEMP_B1S2", "name": "Catalyst Temperature: Bank 1 - Sensor 2", "unit": "°F"},
            "CATALYST_TEMP_B2S2": {"command": "CATALYST_TEMP_B2S2", "name": "Catalyst Temperature: Bank 2 - Sensor 2", "unit": "°F"},
            "PIDS_C": {"command": "PIDS_C", "name": "PIDs C", "unit": ""},
            "STATUS_DRIVE_CYCLE": {"command": "STATUS_DRIVE_CYCLE", "name": "Status Drive Cycle", "unit": ""},
            "CONTROL_MODULE_VOLTAGE": {"command": "CONTROL_MODULE_VOLTAGE", "name": "Control Module Voltage", "unit": "Volts"},
            ...
            "RELATIVE_THROTTLE_POS": {"command": "RELATIVE_THROTTLE_POS", "name": "Relative Throttle Position", "unit": "%"},
            ...
            "TIME_SINCE_DTC_CLEARED": {"command": "TIME_SINCE_DTC_CLEARED", "name": "Time Since DTC Cleared", "unit": "Minutes"},
            ...
            "EVAP_VAPOR_PRESSURE_ABS": {"command": "EVAP_VAPOR_PRESSURE_ABS", "name": "Absolute Evap Vapor Pressure", "unit": "kPa"},
            "EVAP_VAPOR_PRESSURE_ALT": {"command": "EVAP_VAPOR_PRESSURE_ALT", "name": "Evap Vapor Pressure Alt", "unit": "Pa"},
            "SHORT_O2_TRIM_B1": {"command": "SHORT_O2_TRIM_B1", "name": "Short term secondary O2 trim - Bank 1", "unit": "%"},
            "LONG_O2_TRIM_B1": {"command": "LONG_O2_TRIM_B1", "name": "Long term secondary O2 trim - Bank 1", "unit": "%"},
            "SHORT_O2_TRIM_B2": {"command": "SHORT_O2_TRIM_B2", "name": "Short term secondary O2 trim - Bank 2", "unit": "%"},
            "LONG_O2_TRIM_B2": {"command": "LONG_O2_TRIM_B2", "name": "Long term secondary O2 trim - Bank 2", "unit": "%"},
            "FUEL_RAIL_PRESSURE_ABS": {"command": "FUEL_RAIL_PRESSURE_ABS", "name": "Fuel Rail Pressure Absolute", "unit": "kPa"},
            "RELATIVE_ACCEL_POS": {"command": "RELATIVE_ACCEL_POS", "name": "Relative Acceleration Position", "unit": "%"},
            "HYBRID_BATTERY_REMAINING": {"command": "HYBRID_BATTERY_REMAINING", "name": "Hybrid Battery Remaining", "unit": "%"},
    ...
    def insert_data_into_database(self):
        ...
        if self.db_conn is not None and self.db_conn.is_connected():
            ...
            printc("RUNTIME: ", self.data_dict['RUN_TIME']['value'])

            if self.data_dict['RUN_TIME']['value'] == 0:
                upload_data()
                printc("STOPPING COLLECTION")
